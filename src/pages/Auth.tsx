  ...
  return (
    <div className="min-h-screen animated-gradient flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full">
        {!isConfigured && (
          <div className="max-w-lg mx-auto mb-4 rounded-xl bg-amber-50 border border-amber-200 p-4 text-amber-900">
            Authentication needs VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY in .env. Add the project's existing Supabase credentials, then restart Vite.
          </div>
        )}
        {isLogin ? (
